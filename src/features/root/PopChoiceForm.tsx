...
export default function PopChoiceForm() {
    const [formErrors, formAction, isFormSubmissionInProgress] = useActionState<PopChoiceFormProps, FormData>(performRagAndRecommendMovie, undefined);
    ...
    useEffect(() => {
        if (formErrors?.errors) {
            if (formErrors.errors.question1) {
                toast.error(formErrors.errors.question1, {
                    duration: 5000,
                    position: "top-right",
                });
            }
            if (formErrors.errors.question2) {
                toast.error(formErrors.errors.question2, {
                    duration: 5000,
                    position: "top-right",
                });
            }
            if (formErrors.errors.question3) {
                toast.error(formErrors.errors.question3, {
                    duration: 5000,
                    position: "top-right",
                });
            }
            if (formErrors.errors.message) {
                toast.error(formErrors.errors.message, {
                    duration: 5000,
                    position: "top-right",
                });
            }
